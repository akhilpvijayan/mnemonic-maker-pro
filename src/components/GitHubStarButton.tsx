...
const GitHubStarButton: React.FC<GitHubStarButtonProps> = ({ repoUrl }) => {
  ...
  return (
    <button onClick={handleClick} className="github-badge">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="github-logo">
      ...
      <div className="github-text-container">
        <span className="github-featured">STAR ON</span>
        <span className="github-title">GitHub</span>
      </div>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="github-star">
        <path d="M8 0L10.163 5.505L16 6.383L12 10.267L12.946 16L8 13.255L3.054 16L4 10.267L0 6.383L5.837 5.505L8 0Z" fill="#FFA500"/>
      </svg>
    </button>
  );
};
